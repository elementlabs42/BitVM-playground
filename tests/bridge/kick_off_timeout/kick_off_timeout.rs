...
async fn test_kick_off_timeout_tx() {
    ...
    kick_off_timeout_tx.pre_sign(&verifier_0_context, &connector_1, &secret_nonces_0);
    kick_off_timeout_tx.pre_sign(&verifier_1_context, &connector_1, &secret_nonces_1);
